const descriptionCopy = {
  main: {
    ...
    pl: 
      `jestem graficzką i ilustratorką. Nadal pracuję nad nad tym, aby ta strona była dostępna. 
      Znajdziesz tutaj: moje portfolio, więcej informacji o mnie i o tym jak
